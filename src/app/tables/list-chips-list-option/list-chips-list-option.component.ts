...
import {VERSION, MatCard} from '@angular/material';
...
@Component({
  selector: 'app-list-chips-list-option',
  templateUrl: './list-chips-list-option.component.html',
  styleUrls: ['./list-chips-list-option.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ListChipsListOptionComponent implements OnInit {
  version = VERSION;
  form: FormGroup;
